...
class Program
{
    static void Main()
    {
        ...
        int[] increasingElements = insertSortInstance.Increasing(disorderedElements);
        int[] decreasingElements = insertSortInstance.Decreasing(disorderedElements);

        Console.WriteLine("Elementos ordenados de forma crescente");
        Console.WriteLine(string.Join(", ", increasingElements));

        Console.WriteLine("Elementos ordenados de forma decrescente");
        Console.WriteLine(string.Join(", ", decreasingElements));
    }
}

class InsertSort
{
    public int[] Increasing(int[] elements)
    {
    ...
    public int[] Decreasing(int[] elements)
    {
        int[] ordenedElements = (int[])elements.Clone();
